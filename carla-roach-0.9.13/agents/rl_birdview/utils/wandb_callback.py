...
class WandbCallback(BaseCallback):
    ...
    def _on_training_start(self) -> None:
        print("on training start in side wandb_callback.py")
        pass

    def _on_rollout_start(self):
        # self.model._last_obs = self.model.env.reset()
        print("on rollout start in side wandb_callback.py")
        pass
    ...
    def _on_rollout_end(self):
        print("on rollout end in side wandb_callback.py")
    ...
    def evaluate_policy(env, policy, video_path, min_eval_steps=3000):
        print("evaluate policy inside wandb_callback.py")
        policy = policy.eval()
        t0 = time.time()
