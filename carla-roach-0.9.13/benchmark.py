...
def run_single(run_name, env, agents_dict, agents_log_dir, log_video, max_step=None, show_pygame=False):
    ...
    while not done['__all__']:
        ...
        if log_video:
            ...
            if show_pygame:
                display.display_image(img, None)
...
def run_env(cfg, 
    ...
    for task_idx in range(ckpt_task_idx, env.num_tasks):
        log.info(f"Start Benchmarking env_idx {env_idx}, task_idx {task_idx}, suite_name: {suite_name}")
