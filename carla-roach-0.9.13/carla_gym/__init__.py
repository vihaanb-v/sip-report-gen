...
_AVAILABLE_ENVS = {
    ...
    'Roundabout-v0': {
        'entry_point': 'carla_gym.envs:RoundaboutEnv',
        'description': 'roundabout environment for reinforcement learning training and testing',
        'kwargs': {}
    },
    'CogMod-v0': {
        'entry_point': 'carla_gym.envs:CogModEnv',
        'description': 'cognitive modeling environment for reinforcement learning training and testing',
        'kwargs': {}
    }
}
