...
class CarlaMultiAgentEnv(gym.Env):
    def __init__(self, carla_map, host, port, seed, no_rendering,
        ...
        self._zv_handler = ZombieVehicleHandler(self._client, tm_port=self._tm.get_port(), spawn_distance_to_ev=15)
    ...
    def _init_client(self, carla_map, host, port, seed=2021, no_rendering=False):
        ...
        while client is None:
            try:
                ...
                logger.info(f"client.get_server_version(): {client.get_server_version()}, client.get_client_version(): {client.get_client_version()}")
