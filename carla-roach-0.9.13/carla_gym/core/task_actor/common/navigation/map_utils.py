...
def get_sampled_topology(map_topology, resolution):
    ...
    topology into a list of dictionary objects. The pair of waypoints must be maximum
    resolution meter apart. If they are not, intermediate waypoints are calculated
    which are resolution meter apart and stored in path.
        ...
        :return topology: list of dictionary objects with the following attributes
            ...
            path    -   list of waypoints separated by resolution meter from entry
                        to exit. It does not contain entry and exit.
    """
    topology = []
