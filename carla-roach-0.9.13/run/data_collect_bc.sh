...
data_collect () {
  python -u /media/mahi/F69E96C49E967D35/carla-roach/data_collect.py resume=true log_video=false save_to_wandb=false \
  wb_project=il_leaderboard_roach \
  wb_group=bc_data \
  test_suites=eu_data \
  n_episodes=160 \
  dataset_root=/media/mahi/F69E96C49E967D35/roach_dataset/bc \
